...
}), zObservabilityQueryResult = external_exports.object({
  columns: external_exports.array(external_exports.string()),
  rows: external_exports.array(external_exports.array(external_exports.unknown()))
...
var zWorkersKvNamespaceGetMultipleKeyValuePairsData = external_exports.object({
  ...
  body: external_exports.object({
    ...
    rollback: external_exports.boolean().optional()
  }),
  path: external_exports.object({
    workflow_name: zWorkflowsWorkflowName,
    instance_id: zWorkflowsInstanceId
...
var zObservabilityQueryData = external_exports.object({
  body: external_exports.object({
...
), zObservabilityClearData = external_exports.object({
  body: external_exports.never().optional(),
  path: external_exports.never().optional(),
  query: external_exports.never().optional()
});
